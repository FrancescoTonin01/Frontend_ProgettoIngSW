<template>
  ...
  const allFeatures = [
    ...
    { icon: 'fas fa-sign-in-alt', title: 'login1', description: 'loginDescription', route: '/login' },
  ...
  // Funzione per mostrare le funzioni in base all'utente loggato
  const visibleFeatures = computed(() => {
    return allFeatures.filter(feature => {
      if (isLoggedIn.value) {
        return !['register', 'login1'].includes(feature.title);
      }
