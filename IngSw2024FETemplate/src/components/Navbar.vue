  ...
  <nav>
    <ul>
      ...
      <div class="right-links">
        <li v-if="!isLoggedIn"><router-link to="/AuthView">{{ $t('login1') }}</router-link></li>
        <li v-if="isLoggedIn" class="dropdown">
          <button @click="toggleUserMenu" class="dropdown-button">
            {{ $t('account') }} ▼
          </button>
...
// Funzione per mostrare il menu della lingua
...
// Funzione per nascondere il menu dell'utente quando l'utente è loggato
